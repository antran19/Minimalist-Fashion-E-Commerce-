...
VALUES
    ...
    ((SELECT id FROM dbo.products WHERE slug = N'everyday-zip-hoodie'), N'https://res.cloudinary.com/dcroyqkoa/image/upload/v1784721527/uminimalist/products/everyday-zip-hoodie/everyday-zip-hoodie-cream.jpg', N'uminimalist/products/everyday-zip-hoodie/everyday-zip-hoodie-cream', N'Cream', 1, 0, GETUTCDATE()),
    ((SELECT id FROM dbo.products WHERE slug = N'everyday-zip-hoodie'), N'https://res.cloudinary.com/dcroyqkoa/image/upload/v1784721529/uminimalist/products/everyday-zip-hoodie/everyday-zip-hoodie-black.jpg', N'uminimalist/products/everyday-zip-hoodie/everyday-zip-hoodie-black', N'Black', 0, 1, GETUTCDATE()),
    ((SELECT id FROM dbo.products WHERE slug = N'everyday-zip-hoodie'), N'https://res.cloudinary.com/dcroyqkoa/image/upload/v1784721531/uminimalist/products/everyday-zip-hoodie/everyday-zip-hoodie-red.jpg', N'uminimalist/products/everyday-zip-hoodie/everyday-zip-hoodie-red', N'Red', 0, 2, GETUTCDATE()),
