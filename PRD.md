...
U-Minimalist là một website thương mại điện tử chuyên bán quần áo theo phong cách tối giản. Sản phẩm hướng đến trải nghiệm mua sắm đơn giản, dễ sử dụng, giúp khách hàng nhanh chóng tìm được sản phẩm phù hợp theo danh mục, size, màu sắc và giá tiền.

Ngoài chức năng mua sắm cho khách hàng, hệ thống còn cung cấp trang quản trị cho Admin để quản lý sản phẩm, danh mục, biến thể sản phẩm, tồn kho, đơn hàng và doanh thu.

Sản phẩm được xây dựng bằng Java 17, Spring MVC, Hibernate ORM, Spring Data JPA, Spring Security, Thymeleaf, Bootstrap 5 và Microsoft SQL Server.
...
Sản phẩm U-Minimalist cần đạt các mục tiêu sau:

* Cung cấp nền tảng mua sắm quần áo online đơn giản, dễ dùng.
* Cho phép người dùng xem, tìm kiếm và lọc sản phẩm.
* Cho phép khách hàng chọn đúng biến thể sản phẩm theo size và màu sắc.
* Cho phép khách hàng thêm sản phẩm vào giỏ hàng và đặt hàng.
* Cho phép khách hàng theo dõi lịch sử và trạng thái đơn hàng.
* Cho phép Admin quản lý sản phẩm, danh mục, biến thể và tồn kho.
* Cho phép Admin xử lý đơn hàng và xem thống kê doanh thu cơ bản.
* Đảm bảo phân quyền rõ ràng giữa Guest, Customer và Admin.

## 2.2. Mục tiêu kỹ thuật

* Ứng dụng phải sử dụng Spring MVC làm framework chính.
* Dữ liệu phải được quản lý bằng Hibernate ORM và Spring Data JPA.
* Hệ thống phải kết nối Microsoft SQL Server.
* Hệ thống phải có xác thực và phân quyền bằng Spring Security.
* Giao diện phải được render bằng Thymeleaf.
* Giao diện cần responsive bằng Bootstrap 5.
* Code cần tổ chức rõ ràng theo mô hình MVC.

---

# 3. Vấn đề người dùng cần giải quyết
...
Admin của cửa hàng thường gặp các vấn đề:

* Khó quản lý tồn kho chi tiết theo từng size và màu.
* Khó cập nhật thông tin sản phẩm nhanh chóng.
* Khó kiểm soát đơn hàng mới, đơn đang giao và đơn hoàn tất.
* Khó theo dõi doanh thu nếu không có dashboard.
...
Sản phẩm bao gồm các nhóm chức năng sau:
...
## 5.2. Chức năng ngoài phạm vi

Trong phiên bản đầu tiên, sản phẩm chưa bao gồm:
...
# 6. Định nghĩa vai trò và quyền truy cập

| Vai trò  | Mô tả                     | Quyền chính                                          |
| -------- | ------------------------- | ---------------------------------------------------- |
| Guest    | Người dùng chưa đăng nhập | Xem, tìm kiếm, lọc sản phẩm, đăng ký, đăng nhập      |
| Customer | Người dùng đã đăng nhập   | Mua hàng, quản lý giỏ hàng, đặt hàng, xem đơn hàng   |
| Admin    | Quản trị viên             | Quản lý sản phẩm, kho, đơn hàng, khách hàng, báo cáo |
...
16. Customer xem đơn hàng trong lịch sử đơn hàng.
...
8. Admin cập nhật Completed khi giao thành công.
9. Doanh thu được ghi nhận khi đơn hàng Completed.

---

# 8. Danh sách chức năng sản phẩm
...
* Customer đăng nhập thành công được chuyển đến trang chủ hoặc trang tài khoản.
* Admin đăng nhập thành công được chuyển đến Admin Dashboard.
...
Trang chủ hiển thị hình ảnh thương hiệu, danh mục nổi bật và sản phẩm nổi bật.
...
* Product Variant phải tồn tại.
* Số lượng thêm vào không vượt quá tồn kho.
...
* Khi thay đổi số lượng, tổng tiền cập nhật ngay.
...
* Đơn hàng vẫn phải có thông tin thanh toán rõ ràng.
...
## 14.1. Chỉ số chức năng

Sản phẩm được xem là hoàn thành khi:

* 100% chức năng Must Have hoạt động.
* Customer có thể hoàn tất luồng mua hàng từ xem sản phẩm đến đặt hàng.
* Admin có thể tạo sản phẩm có biến thể và tồn kho.
* Admin có thể xử lý đơn hàng.
* Hệ thống phân quyền chính xác.

## 14.2. Chỉ số kỹ thuật

* Ứng dụng chạy được bằng Maven.
* Kết nối thành công SQL Server.
* Hibernate tạo hoặc mapping đúng database.
* Không có lỗi nghiêm trọng trong luồng đặt hàng.
* Không có lỗi phân quyền nghiêm trọng.

## 14.3. Chỉ số trải nghiệm

* Người dùng có thể tìm sản phẩm bằng tìm kiếm hoặc bộ lọc.
* Người dùng có thể hiểu rõ sản phẩm đang chọn size nào, màu nào.
* Người dùng thấy được tổng tiền trước khi đặt hàng.
* Admin dễ dàng nhận biết sản phẩm sắp hết hàng.
...
Phiên bản MVP cần có các chức năng sau:
...
## Giai đoạn 3: Customer UI và Product Browsing
...
## Giai đoạn 4: Security, Cart và Checkout
...
## Giai đoạn 5: Order Management và Payment
...
## Giai đoạn 6: Dashboard, Testing và Finalize
...
# 18. Test Scenarios chính

## TS-01: Đăng ký tài khoản

* Guest nhập thông tin hợp lệ.
* Hệ thống tạo tài khoản Customer.
* Người dùng đăng nhập được bằng tài khoản mới.

## TS-02: Đăng nhập sai mật khẩu

* User nhập email đúng nhưng mật khẩu sai.
* Hệ thống báo lỗi.
...
* Customer có sản phẩm trong giỏ.
* Customer nhập thông tin giao hàng.
...
* Customer nhập số lượng lớn hơn tồn kho.
* Hệ thống không cho đặt hàng.
* Hệ thống hiển thị thông báo lỗi.

## TS-06: Admin tạo sản phẩm

* Admin nhập thông tin sản phẩm hợp lệ.
* Admin chọn danh mục.
* Hệ thống lưu sản phẩm thành công.

## TS-07: Admin tạo biến thể trùng

* Admin tạo biến thể có cùng Product, Size và Color với biến thể đã tồn tại.
* Hệ thống báo lỗi.
* Biến thể không được tạo.

## TS-08: Admin cập nhật trạng thái đơn hàng

* Admin chuyển đơn Pending sang Confirmed.
...
# 20. Tiêu chí hoàn thành sản phẩm
...
U-Minimalist là một sản phẩm thương mại điện tử thời trang tối giản, tập trung vào hai nhóm người dùng chính: Customer và Admin. Customer cần trải nghiệm mua hàng rõ ràng, nhanh chóng và chính xác khi chọn sản phẩm theo size và màu. Admin cần công cụ quản lý sản phẩm, biến thể, tồn kho và đơn hàng một cách hiệu quả.

PRD này xác định rõ mục tiêu sản phẩm, người dùng mục tiêu, chức năng cần xây dựng, yêu cầu giao diện, yêu cầu dữ liệu, business rules, roadmap và tiêu chí hoàn thành. Đây sẽ là tài liệu nền tảng để nhóm phát triển tiếp tục xây dựng SRS, Use Case, ERD, database schema và triển khai code trong dự án HSF301.
